<div style="background: white; border-radius: 8px; padding: 20px; font-family: 'Inter', sans-serif;">
    ...
    <div style="text-align: center; margin-bottom: 20px; border-bottom: 2px solid #000; padding-bottom: 10px;">
        ...
        <p style="margin: 5px 0 0 0; color: #000;">Cash Salary Disbursement Sheet for {{ \Carbon\Carbon::parse($month)->format('M-Y') }}</p>
    </div>
    ...
    <table style="width: 100%; border-collapse:collapse; color: #000;" border="1">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td style="padding:8px; width: 150px;"></td>
            </tr>
            @empty
            <tr><td colspan="5" style="padding: 20px; text-align: center;">No processed cash salaries found.</td></tr>
            @endforelse
        </tbody>
    </table>
</div>
